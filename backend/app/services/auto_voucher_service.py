...
_PURCHASE_KEYWORD_MAP: List[Tuple[Tuple[str, ...], str, str]] = [
    # (키워드들, 계정코드, 계정명)
    # === 그랜터 카드/통장 거래처 특화 규칙 (2026-06-04, 소모품비 catch-all 보정) ===
    # 위하고 분개장 대조 결과 소모품비(830)로 오분류되던 거래처들을 우선 매핑.
    (("네이버파이낸셜", "네이버 파이낸셜"), "839", "판매수수료"),
    (("facebk", "facebook", "fb.me", "meta platform", "메타플랫폼", "인스타그램광고"), "833", "광고선전비"),
    (("다우데이타", "데이터라이즈", "빌링_nice", "빌링 nice", "정기결제", "다날", "googleads", "google ads", "google cloud", "aws ", "amazon web"), "831", "지급수수료(판)"),
    (("cj대한통운", "한진택배", "로젠택배", "우체국택배", "운송장", "택배비"), "824", "운반비"),
    # 광고: 구글 애드워즈 (한글/영문 표기)
    (("구글애드워즈", "구글 애드워즈", "애드워즈", "adwords"), "833", "광고선전비"),
    # SaaS/소프트웨어 구독 → 지급수수료
    (("어도비", "adobe", "openai", "chatgpt", "freee", "notion", "slack", "figma", "github", "microsoft 365", "office365"), "831", "지급수수료(판)"),
    # PG/핀테크 결제대행 수수료 → 지급수수료
    (("고위드", "gowid", "이니시스", "inicis", "kcp", "스마트로", "나이스페이", "정기과금_나이스", "정기과금", "엔에이치엔케이씨피", "kcp-결제"), "831", "지급수수료(판)"),
    # === 기존 매입 키워드 규칙 ===
    ...
    # 판매채널 거래처 = 판매수수료(정산/입점 수수료). 종전 소모품비(830) 오분류 → 839로 수정.
    (("쿠팡", "마켓컬리", "네이버페이", "스마트스토어", "11번가", "지마켓", "옥션", "위메프", "티몬", "지그재그", "에이블리"), "839", "판매수수료"),
